...
function runTimes() {
  var clock_wrap = document.querySelector("#clock_wrap"),
  ...
  hours.innerText = date_h < 10 ? "0".concat(date_h) : "".concat(date_h);
  minutes.innerText = date_m < 10 ? "0".concat(date_m) : "".concat(date_m);
  seconds.innerText = date_s < 10 ? "0".concat(date_s) : "".concat(date_s);
...
module.exports = __webpack_require__(/*! E:\phpstorm\laravel-project\resources\js\clock.js */"./resources/js/clock.js");
